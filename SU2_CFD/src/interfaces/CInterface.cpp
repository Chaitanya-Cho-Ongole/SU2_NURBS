 ...
 */
 ...
 CInterface::CInterface() :
   ...
   size(SU2_MPI::GetSize()) {
     static int counter=0;
      if (counter==0){
        std::cout<<"FILE:SU2_CFD/src/interfaces/CInterface.cpp"<<std::endl;
        std::cout<<"FUNCTION:CInterface::CInterface"<<std::endl;
      }
 ...
 void CInterface::BroadcastData(const CInterpolator& interpolator,
   ...
   static int counter=0;
      if (counter==0){
        std::cout<<"FILE:SU2_CFD/src/interfaces/CInterface.cpp"<<std::endl;
        std::cout<<"FUNCTION:CInterface::BroadcastData"<<std::endl;
      }
 ...
 void CInterface::PreprocessAverage(CGeometry *donor_geometry, CGeometry *target_geometry,
   ...
   static int counter=0;
      if (counter==0){
        std::cout<<"FILE:SU2_CFD/src/interfaces/CInterface.cpp"<<std::endl;
        std::cout<<"FUNCTION:CInterface::PreprocessAverage"<<std::endl;
      }
 ...
 void CInterface::AllgatherAverage(CSolver *donor_solution, CSolver *target_solution,
   ...
   static int counter=0;
      if (counter==0){
        std::cout<<"FILE:SU2_CFD/src/interfaces/CInterface.cpp"<<std::endl;
        std::cout<<"FUNCTION:CInterface::AllgatherAverage"<<std::endl;
      }
 ...
 void CInterface::GatherAverageValues(CSolver *donor_solution, CSolver *target_solution, unsigned short donorZone){
   ...
   static int counter=0;
      if (counter==0){
        std::cout<<"FILE:SU2_CFD/src/interfaces/CInterface.cpp"<<std::endl;
        std::cout<<"FUNCTION:CInterface::GatherAverageValues"<<std::endl;
      }
