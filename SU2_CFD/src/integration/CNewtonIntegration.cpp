 ...
 */
 ...
 public:
   ...
   inline void operator()(const CSysVector<Scalar>& u, CSysVector<Scalar>& v) const override {
    ...
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CMatrixFreeProductWrapper::operator()"<<std::endl;
    }
 ...
 public:
   ...
   inline void operator()(const CSysVector<Scalar>& u, CSysVector<Scalar>& v) const override {
    ...
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CPreconditionerWrapper::operator()"<<std::endl;
    }
 ...
 CNewtonIntegration::~CNewtonIntegration() {
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::~CNewtonIntegration"<<std::endl;
    }
 ...
 void CNewtonIntegration::Setup() {
   ...
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::Setup"<<std::endl;
    }
 ...
 void CNewtonIntegration::PerturbSolution(const CSysVector<Scalar>& dir, Scalar mag) {
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::PerturbSolution"<<std::endl;
    }
 ...
 void CNewtonIntegration::ComputeResiduals(ResEvalType type) {
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::ComputeResiduals"<<std::endl;
    }
 ...
 void CNewtonIntegration::ComputeFinDiffStep() {
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::ComputeFinDiffStep"<<std::endl;
    }
 ...
 void CNewtonIntegration::MultiGrid_Iteration(CGeometry ****geometry_, CSolver *****solvers_, CNumerics ******numerics_,
   ...
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::MultiGrid_Iteration"<<std::endl;
    }
 ...
 void CNewtonIntegration::MatrixFreeProduct(const CSysVector<Scalar>& u, CSysVector<Scalar>& v) {
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::MatrixFreeProduct"<<std::endl;
    }
 ...
 void CNewtonIntegration::Preconditioner(const CSysVector<Scalar>& u, CSysVector<Scalar>& v) const {
   static int counter=0;
    if (counter==0){
      std::cout<<"FILE:SU2_CFD/src/integration/CNewtonIntegration.cpp"<<std::endl;
      std::cout<<"FUNCTION:CNewtonIntegration::Preconditioner"<<std::endl;
    }
