 ...
 */
 ...
 CCSVFileWriter::CCSVFileWriter(CParallelDataSorter *valDataSorter) :
   ...
   if (counter==0){
     std::cout<<"FILE:SU2_CFD/src/output/filewriter/CCSVFileWriter.cpp"<<std::endl;
     std::cout<<"FUNCTION:CCSVFileWriter::CCSVFileWriter"<<std::endl;
   }
 ...
 void CCSVFileWriter::WriteData(string val_filename){
   ...
   if (counter==0){
     std::cout<<"FILE:SU2_CFD/src/output/filewriter/CCSVFileWriter.cpp"<<std::endl;
     std::cout<<"FUNCTION:CCSVFileWriter::WriteData"<<std::endl;
   }
