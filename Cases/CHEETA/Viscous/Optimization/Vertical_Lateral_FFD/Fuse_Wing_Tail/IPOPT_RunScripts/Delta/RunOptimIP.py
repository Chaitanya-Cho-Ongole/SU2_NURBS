...
# Mesh deformation
def_command = "mpirun -n " + ncores1 + " SU2_DEF " + deformMaster
...
# Forward analysis
cfd_command = "mpirun -n " + ncores1 + " SU2_CFD " + configMaster
...
# NOTE: Use "zero_except_last" as False and "zero_last" as True to ensure that CD sensitivities are zero for tail rotation
...
# NOTEL Use "zero_except_last" as True and "zero_last" as False to ensure that CMy sensitivities are non-zero only for tail rotation
mom.addInputVariable(ffd,"MOM_ADJ/of_grad.dat",TableReader(None,0,(1,0),delim="",zero_except_last=True, zero_last=False))
...
# WING VOLUME SCALING PARAMETERS (MKiV)
BSL_WING_VOL = 14.9085
FACTOR_WV = 0.99
TRG_WING_VOL = BSL_WING_VOL * FACTOR_WV

# FUSELAGE VOLUME SCALING PARAMETERS (MKiV)
BSL_FUSE_VOL = 409.422
FACTOR_FV = 0.99
...
#driver.addLowerBound(mom, -0.0001, GlobalScale , ConScale)

#driver.addUpperBound(mom, 0.0001, GlobalScale , ConScale)
