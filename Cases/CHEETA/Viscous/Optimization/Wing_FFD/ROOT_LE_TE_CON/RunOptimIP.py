...
ffd = InputVariable(x0,ArrayLabelReplacer("__FFD_PTS__"), 0, np.ones(nDV), -0.09,0.09)
...
# Geometry evaluation
geo_commandWing = "mpirun -n " + ncores2 +  " SU2_GEO " + geoMasterWing

# Forward analysis
cfd_command = "mpirun -n " + ncores3 + " SU2_CFD " + configMaster
